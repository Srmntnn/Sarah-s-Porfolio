  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 className={`${styles.heroHeadText} customFont`}>ABOUT US.</h1>
        <p
          className={`${styles.sectionSubText} max-w-[850px] w-full text-center`}
        >
          We are aspiring developers. We may not have the skill set yet, but we
          are quick and eager to learn different types of technologies.
        </p>
      </div>
      ...
      <section className="md:flex justify-center gap-8">
        ...
        >
          <div className="bg-[#03000C] max-w-[500px]  w-full md:rounded-2xl md:px-10 px-7 py-12 flex items-center md:ml-[40px] rounded-xl md:flex-row flex-col gap-8 shadow-xl">
            <div className="relative max-w-[180px] bg-gradient-to-r from-indigo-500 via-purple-900 to-pink-700 md:rounded-xl rounded-[100vmax] md:ml-[-80px] ">
              <img src={Aenon} alt="Profile-Pic" className=" " />
            </div>
